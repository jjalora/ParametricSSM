...
class LOCP:
    ...
    def __init__(self, N, H, Qz, R, Qzf=None, U=None, X=None, Xf=None, dU=None, verbose=False, warm_start=True,
                 x_char=None, periodic=False, **kwargs):
        self.N = N
        self.H = H
        self.Qz = Qz
        self.R = R
    ...
    def set_objective(self):
        ...
        # TODO: Introduced PSD Wrap to try to fix numerics
        # Control cost
    ...
    def set_constraints(self):
        ...
        if self.periodic:
            ...
            for ii in range(self.N-1):
                constr += [self.u[ii*self.n_u:(ii+1)*self.n_u] == self.u[(ii+1)*self.n_u:(ii+2)*self.n_u]]
